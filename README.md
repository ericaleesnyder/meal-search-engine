...
The structure of this application was made by using language software such as javaScript, JQuery, CSS with the collaboration of the [http://Materializecss.com](Materializecss) that help build the style framework and also using the server-side APIs: [https://developer.edamam.com/edamam-recipe-api](developer.edamam.com) and [https://www.thecocktaildb.com/api.php](www.thecocktaildb.com) for fetching data recipes of the food and drinks from the website, we also used the Local Storage method to store/retrieve data from the website upon the user request.
